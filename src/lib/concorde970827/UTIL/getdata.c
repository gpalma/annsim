...
/**************************
** CCutil_getedgelist_nPS
**************************/

#ifdef CC_PROTOTYPE_ANSI
int CCutil_getedgelist_nPS (int *ncount, match_edge_t *fname, int *ecount, int **elist,
                   int **elen)
#else
int CCutil_getedgelist_nPS (ncount, fname, ecount, elist, elen)
int *ncount;
match_edge_t *fname;
int *ecount, **elist, **elen;
#endif
